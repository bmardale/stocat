...
var (
	...
	AccountReauthenticated      = newAction("account.reauthenticated")
	...
	EncryptionInitialized       = newAction("encryption.initialized")
	EncryptionBundleUpdated     = newAction("encryption.bundle_updated")
	EncryptionIdentityRotated   = newAction("encryption.identity_rotated")
	...
	FileMoved                   = newAction("file.moved")
	...
	RegistrationSettingsUpdated = newAction("registration.settings_updated")
	InviteCodeCreated           = newAction("registration.invite_code_created")
	InviteCodeRevoked           = newAction("registration.invite_code_revoked")
)
