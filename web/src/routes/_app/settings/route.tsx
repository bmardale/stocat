      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-2">
          ...
          <p className="leading-relaxed text-muted-foreground">
            Manage your account details, password, passkeys, encryption, and signed-in devices.
            Review the activity of your account.
          </p>
        </div>
        <nav aria-label="Settings" className="flex gap-6 border-b">
          ...
          <Link to="/settings/encryption" className={linkClass}>
            Encryption
          </Link>
          <Link to="/settings/sessions" className={linkClass}>
            Sessions
          </Link>
          <Link to="/settings/activity" className={linkClass}>
            Activity
          </Link>
        </nav>
      </div>
