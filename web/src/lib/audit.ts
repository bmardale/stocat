...
export const auditActionLabels: Record<AuditEventAction, string> = {
  ...
  "account.reauthenticated": "Password confirmed",
  ...
  "encryption.initialized": "Encryption set up",
  "encryption.bundle_updated": "Encryption keys changed",
  "encryption.identity_rotated": "Encryption identity replaced",
